                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   <td align="left" style="font-size:0px;/* padding: 0px 25px; */padding-right:25px;padding-left:25px;word-break:break-word;" class="">
                                                      <div style="font-family: serif;font-size: 15px;font-weight: 400;line-height: 24px;text-align:left;color: #322c32;margin-top: 11px;" class="">If you did not request a password reset, please ignore this email or reply to let us know. <b>This password reset link is only valid for the next 4 Hours.</b>
                                                         <br>
                                                      </div>
                                                   </td>
                                                </tr>
